...
//admin
            ...
            {/* <Route path="/all-companies/oneCompany" element={<GetOneCompany/>}/> */}
...
//company
            ...
            {/* <Route path="/company/all-coupons/category" element={<CouponsByCategory/>}/>
            <Route path="/company/all-coupons/price" element={<CouponsByPrice/>}/> */}

            <Route path="/company/companyDetails" element={<CompanyArea/>}/>
            <Route path="/companyDetails" element={<GetCompanyDetails/>}/>

            {/* <Route path="/company/add-coupon" element={<CouponList/>}/> */}
